...
describe('AnswerButton', () => {
  ...
  it('does not call onClick when disabled', () => {
    const onClick = jest.fn();
    render(<AnswerButton {...defaultProps} onClick={onClick} disabled={true} />);
  ...
  it('shows correct answer feedback when submitted', () => {
    render(<AnswerButton {...defaultProps} isSubmitted={true} isCorrect={true} />);
  ...
  it('shows incorrect answer feedback when submitted', () => {
    render(<AnswerButton {...defaultProps} isSubmitted={true} isSelected={true} isCorrect={false} />);
  ...
  it('has proper accessibility attributes', () => {
    ...
    expect(button).toHaveAttribute('aria-label', 'Option A: Sample answer text');
  ...
  it('shows feedback with showFeedback prop', () => {
    render(<AnswerButton {...defaultProps} showFeedback={true} isCorrect={true} />);
  ...
  it('handles complex text content', () => {
    const complexText = 'The capital of France is Paris, which is located in northern France.';
